...
# Fetching data from a DB and saving it in a file(path) and sending an automail with that file,msg.
...
filename = "C:\\Users\\pakshay\\Desktop\\NewPro\\report1.html" # In same directory as script
